      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <a
              href={site.phoneHref}
              className="hidden items-center gap-2 rounded-full glass px-4 py-2 text-sm text-frost transition-colors hover:text-solar md:flex"
              data-cursor="hover"
            >
              <FiPhone className="h-4 w-4 text-solar" />
