...
export const metadata: Metadata = {
  title: "About Us",
  description:
    "Xeron Energy is a Rajkot-based Solar EPC contractor founded by electrical engineers with 18 years in India's government power sector. Our story, our values and how we work.",
};
  ...
  return (
    <>
      <PageHero
        ...
        description="Xeron Energy is a young company built on experience that is not. Our founders spent nearly two decades engineering India's government power infrastructure, and we bring that rigour to every rooftop."
      >
        ...
        <div className="container-x grid gap-12 lg:grid-cols-2">
          <Reveal>
            <div className="space-y-5 text-mist">
              ...
              <p className="leading-relaxed">
                We will also be straight with you about our age: Xeron is early, and our project
                list is short. So judge us on what you can actually verify — our engineering
                credentials, the datasheets of the components we quote, and the warranty terms we
                put in writing. Ask for all three before you sign anything, with us or anyone else.
              </p>
            </div>
          </Reveal>
          <Reveal delay={0.1}>
